...
public class DocumentDescriptions {
    ...
    public static final String RESPONSE_PRODUCTS_TOTAL_COUNT = "상품 총 갯수입니다.";
    public static final String RESPONSE_REVIEWS_TOTAL_COUNT = "후기 총 갯수입니다.";
    public static final String RESPONSE_FAVORITE_PRODUCTS_TOTAL_COUNT = "찜한 상품 총 갯수입니다.";
    public static final String RESPONSE_FOLLOWINGS_TOTAL_COUNT = "팔로잉 총 명수입니다.";
    public static final String RESPONSE_FOLLOWERS_TOTAL_COUNT = "팔로워 상품 총 명수입니다.";
    public static final String RESPONSE_IS_TEMPORARY_SAVE = "임시저장 여부입니다.";
    public static final String RESPONSE_IS_AUTHENTICATED = "사용자 인증 여부입니다.";
    ...
    public static final String EXAMPLE_FOLLOWINGS_TOTAL_COUNT = "152";
    public static final String EXAMPLE_FOLLOWERS_TOTAL_COUNT = "223";
    ...
    public static final String EXAMPLE_IS_AUTHENTICATED = "true";
